      ...
      <div className="max-w-[1091px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-10">
          ...
          <div className="col-span-2">
            <p className="text-[#f2f2f2] font-bold text-lg tracking-tight mb-3">Playbill Picks</p>
            <p className="text-[#f2f2f2] text-sm leading-relaxed max-w-45">
          ...
          {Object.entries(LINKS).map(([category, items]) => (
            <div key={category}>
              <p className="text-[#f2f2f2] text-xs font-semibold uppercase tracking-[1.2px] mb-4">
                {category}
              </p>
              <ul className="space-y-2.5">
                {items.map((item) => (
                  <li key={item}>
                    <Link
                      href="#"
                      className="text-[#f2f2f2] text-sm hover:text-white transition-colors block py-2"
                    >
                      {item}
                    </Link>
                  </li>
        ...
        <div className="border-t border-[#2a2a2e] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#f2f2f2] text-xs">
          ...
          <div className="flex gap-5">
            {["Twitter", "Instagram", "TikTok"].map((social) => (
              <Link
                key={social}
                href="#"
                className="text-[#f2f2f2] text-xs hover:text-white transition-colors block py-2"
              >
                {social}
              </Link>
            ))}
